...
class LanguageSwitch extends Component
{
    ...
    public function suggested(array | Closure $suggested): static
    {
    ...
    {
        $this->outsidePanelRoutes = $routes ?? ['auth.login', 'auth.profile', 'auth.register'];
    ...
    public function outsidePanelPlacement(Placement | string | Closure $placement): static
    {
    ...
    public function beforeSpace(string | Closure | null $space): static
    {
        $this->outsidePanelBeforeSpace = $space;

        return $this;
    }

    public function afterSpace(string | Closure | null $space): static
    {
        $this->outsidePanelAfterSpace = $space;

        return $this;
    }

    public function renderHook(string | Closure $hook): static
    {
    ...
    public function userPreferredLocale(string | Closure | null $locale): static
    {
    ...
    public function renderAsUserMenuItem(bool | Closure $condition = true): static
    {
        $this->renderAsUserMenuItem = $condition;

        return $this;
    }

    public function userMenuSort(int | Closure $sort): static
    {
        $this->userMenuSort = $sort;
    ...
    {
        $this->isFixedOutsidePanels = $condition;

        return $this;
    }

    public function buttonStyle(string | Closure $style): static
    {
    ...
    public function flagSize(string | Closure $size): static
    {
        $this->flagSize = $size;
    ...
    public function flagPosition(string | Closure $position): static
    {
    ...
    public function triggerClass(string | Closure | null $class): static
    {
    ...
    public function displayAs(string | Closure $displayAs): static
    {
    ...
    public function itemStyle(string | Closure $style): static
    {
    ...
    public function itemClass(string | Closure | null $class): static
    {
    ...
    public function languageCodeStyle(string | Closure $style): static
    {
        $this->languageCodeStyle = $style;

        return $this;
    }

    public function hideLanguageCode(bool | Closure $insideModal = true, bool | Closure $outsideModal = false): static
    {
        $this->hideLanguageCodeInsideModal = $insideModal;
        $this->hideLanguageCodeOutsideModal = $outsideModal;
    ...
    public function modalGridColumns(int | array | Closure $columns): static
    {
        $this->modalGridColumns = $columns;

        return $this;
    }

    public function modalAlignment(Alignment | string | Closure | null $alignment): static
    {
    ...
    public function modalClass(string | Closure | null $class): static
    {
    ...
    public function beforeCoreContent(string | Htmlable | View | Closure | null $content): static
    {
        $this->beforeCoreContent = $content;

        return $this;
    }

    public function beforeCoreContentClasses(string | Closure | null $classes): static
    {
        $this->beforeCoreContentClasses = $classes;

        return $this;
    }

    public function afterCoreContent(string | Htmlable | View | Closure | null $content): static
    {
        $this->afterCoreContent = $content;

        return $this;
    }

    public function afterCoreContentClasses(string | Closure | null $classes): static
    {
        $this->afterCoreContentClasses = $classes;
    ...
    {
        return (array) $this->evaluate($this->suggested);
    }

    public function isVisibleInsidePanels(): bool
    {
        return $this->evaluate($this->visibleInsidePanels) && count($this->getLocales()) > 1 && $this->isCurrentPanelIncluded();
    }

    public function isVisibleOutsidePanels(): bool
    {
        return $this->evaluate($this->visibleOutsidePanels) && str(request()->route()?->getName())->contains($this->getOutsidePanelRoutes()) && $this->isCurrentPanelIncluded();
    }

    public function isFixedOutsidePanels(): bool
    {
        return (bool) $this->evaluate($this->isFixedOutsidePanels);
    }
    ...
    public function getOutsidePanelPlacement(): Placement
    {
        ...
        return match (true) {
            $outsidePanelPlacement instanceof Placement => $outsidePanelPlacement, is_string($outsidePanelPlacement) => Placement::tryFrom($outsidePanelPlacement) ?? Placement::TopRight, default => Placement::TopRight
        };
    }

    public function getOutsidePanelBeforeSpace(): ?string
    {
        return $this->evaluate($this->outsidePanelBeforeSpace);
    }

    public function getOutsidePanelAfterSpace(): ?string
    {
        return $this->evaluate($this->outsidePanelAfterSpace);
    }
    ...
    public function isRenderedAsUserMenuItem(): bool
    {
        return (bool) $this->evaluate($this->renderAsUserMenuItem);
    }

    public function getUserMenuSort(): int
    {
        return (int) $this->evaluate($this->userMenuSort);
    }

    public function getButtonStyle(): string
    {
        return (string) $this->evaluate($this->buttonStyle);
    }
    ...
    {
        return (string) $this->evaluate($this->iconSize);
    }

    public function getIconPosition(): string
    {
        return (string) $this->evaluate($this->iconPosition);
    }

    public function getFlagSize(): string
    {
        return (string) $this->evaluate($this->flagSize);
    }

    public function getFlagPosition(): string
    {
        return (string) $this->evaluate($this->flagPosition);
    }

    public function getTriggerClass(): ?string
    {
        return $this->evaluate($this->triggerClass);
    }
    ...
    {
        return (string) $this->evaluate($this->displayAs);
    }

    public function getItemStyle(): string
    {
        return (string) $this->evaluate($this->itemStyle);
    }
    ...
    public function getLanguageCodeStyle(): string
    {
        return (string) $this->evaluate($this->languageCodeStyle);
    }

    public function isLanguageCodeHiddenInsideModal(): bool
    {
        return (bool) $this->evaluate($this->hideLanguageCodeInsideModal);
    }

    public function isLanguageCodeHiddenOutsideModal(): bool
    {
        return (bool) $this->evaluate($this->hideLanguageCodeOutsideModal);
    }
    ...
    public function getModalGridColumns(): int
    {
        return (int) $this->evaluate($this->modalGridColumns);
    }

    public function getModalAlignment(): Alignment | string | null
    {
        return $this->evaluate($this->modalAlignment);
    }

    public function hasModalCloseButton(): ?bool
    {
        return $this->evaluate($this->modalCloseButton);
    }

    public function isModalAutofocused(): ?bool
    {
        return $this->evaluate($this->modalAutofocus);
    }
    ...
    {
        return $this->evaluate($this->closeModalByClickingAway);
    }

    public function isModalClosedByEscaping(): ?bool
    {
        return $this->evaluate($this->closeModalByEscaping);
    }

    public function getModalClass(): ?string
    {
        return $this->evaluate($this->modalClass);
    }

    public function getBeforeCoreContent(): string | Htmlable | View | null
    {
        return $this->evaluate($this->beforeCoreContent);
    }

    public function getBeforeCoreContentClasses(): ?string
    {
        return $this->evaluate($this->beforeCoreContentClasses);
    }

    public function getAfterCoreContent(): string | Htmlable | View | null
    {
        return $this->evaluate($this->afterCoreContent);
    }

    public function getAfterCoreContentClasses(): ?string
    {
        return $this->evaluate($this->afterCoreContentClasses);
    }
    ...
    {
        $locale = session()->get('locale') ?? request()->get('locale') ?? request()->cookie('filament_language_switch_locale') ?? $this->getUserPreferredLocale() ?? config('app.locale', 'en') ?? request()->getPreferredLanguage();
    ...
    {
        return collect(filament()->getPanels())->reject(fn (Panel $panel): bool => in_array($panel->getId(), $this->getExcludes()))->toArray();
    }
    ...
    public function isCurrentPanelIncluded(): bool
    {
        ...
        return $panel ? array_key_exists($panel->getId(), $this->getPanels()) : false;
    }

    public function getCharAvatar(string $locale): string
    {
        return str($locale)->length() > 2 ? str($locale)->substr(0, 2)->upper()->toString() : str($locale)->upper()->toString();
    }
