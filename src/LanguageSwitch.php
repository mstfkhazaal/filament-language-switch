...
class LanguageSwitch extends Component
{
    ...
    public function displayFullLabel(bool | Closure $condition = true): static
    {
        $this->displayFullLabel = $condition;
    ...
    public function modalGridColumns(int | Closure $columns): static
    {
    ...
    public function isDisplayFullLabel(): bool
    {
        return (bool) $this->evaluate($this->displayFullLabel);
    }
